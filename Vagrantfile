...
Vagrant.configure("2") do |config|
        ...
        config.vm.define "node1" do |node1|
                ...
                node1.vm.network "public_network", bridge: NIC, use_dhcp_assigned_default_route: true
        ...
        config.vm.define "node2" do |node2|
                ...
                node2.vm.network "public_network", bridge: NIC, use_dhcp_assigned_default_route: true
